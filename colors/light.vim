...
if (has('termguicolors') && &termguicolors) || has('gui_running')
  ...
  hi Pmenu guifg=#000000 guibg=#f8f8f8 gui=NONE cterm=NONE
  hi PmenuSbar guifg=#f4f4f4 guibg=#f8f8f8 gui=NONE cterm=NONE
  hi PmenuSel guifg=#f8f8f8 guibg=#156adf gui=NONE cterm=NONE
  hi PmenuThumb guifg=#e5e5e5 guibg=#f8f8f8 gui=NONE cterm=NONE
  ...
  hi GitSignsAdd guifg=#22863a guibg=NONE
  hi GitSignsChange guifg=#1b7c83 guibg=NONE
  hi GitSignsDelete guifg=#d73a49 guibg=NONE
...
if s:t_Co >= 256
  ...
  hi Empty ctermfg=16 ctermbg=NONE cterm=NONE
