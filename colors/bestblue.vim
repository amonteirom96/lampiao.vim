...
hi VertSplit guifg=#1e2f37 ctermfg=235 guibg=#1e2f37 ctermbg=235 gui=NONE cterm=NONE
hi Folded guifg=#585858 ctermfg=242 guibg=#1e2f37 ctermbg=234 gui=NONE cterm=NONE
hi FoldColumn guifg=#585858 ctermfg=242 guibg=#1e2f37 ctermbg=234 gui=NONE cterm=NONE
hi SignColumn guifg=#7f7f7f ctermfg=246 guibg=#1e2f37 ctermbg=235 gui=NONE cterm=NONE
...
hi Normal guifg=#dcdcdc ctermfg=255 guibg=#1e2f37 ctermbg=235 gui=NONE cterm=NONE
...
hi WildMenu guifg=#1e2f37 ctermfg=235 guibg=#bbc035 ctermbg=185 gui=Bold cterm=Bold
...
if has('nvim')
  let g:terminal_color_foreground = "#1e2f37"
  let g:terminal_color_background = "#dcdcdc"
  let g:terminal_color_0 = "#1e2f37"
