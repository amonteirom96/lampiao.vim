...
let s:palette = {}
let s:palette.bg        = {'dark': "#0F1419",  'light': "#F0F0F0",  'mirage': "#212733"}

let s:palette.comment   = {'dark': "#5C6773",  'light': "#8A8D90",  'mirage': "#5C6773"}
let s:palette.markup    = {'dark': "#F07178",  'light': "#F07178",  'mirage': "#F07178"}
let s:palette.constant  = {'dark': "#FFEE99",  'light': "#7A52B3",  'mirage': "#D4BFFF"}
...
let s:palette.string    = {'dark': "#B8CC52",  'light': "#6B8E23",  'mirage': "#BBE67E"}
...
let s:palette.selection = {'dark': "#253340",  'light': "#E0E0E0",  'mirage': "#343F4C"}
let s:palette.fg        = {'dark': "#E6E1CF",  'light': "#3C4C55",  'mirage': "#D9D7CE"}
