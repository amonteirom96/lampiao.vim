...
" ----------------------------------------------------------------------------
let s:palette = {}
let s:palette.bg        = {'dark': "#0F1419",  'light': "#E5E5E5",  'mirage': "#212733"}

let s:palette.comment   = {'dark': "#5C6773",  'light': "#6A7075",  'mirage': "#5C6773"}
let s:palette.markup    = {'dark': "#F07178",  'light': "#F07178",  'mirage': "#F07178"}
let s:palette.constant  = {'dark': "#FFEE99",  'light': "#624296",  'mirage': "#D4BFFF"}
...
let s:palette.string    = {'dark': "#B8CC52",  'light': "#5A760E",  'mirage': "#BBE67E"}
...
let s:palette.selection = {'dark': "#253340",  'light': "#C0C0C0",  'mirage': "#343F4C"}
let s:palette.fg        = {'dark': "#E6E1CF",  'light': "#2C3C45",  'mirage': "#D9D7CE"}
