...
hi Search       guifg=#2B2B2B     guibg=#EBCB8B  " Substituindo o azul claro por amarelo
...
hi Statement    guifg=#EBCB8B     gui=bold  " Substituindo o azul claro por amarelo
hi Keyword      guifg=#9876AA     gui=bold
hi Function     guifg=#EBCB8B     " Substituindo o azul claro por amarelo
...
hi htmlTagName  guifg=#EBCB8B  " Substituindo o azul claro por amarelo
...
hi TerminalBlue        guifg=#EBCB8B  " Substituindo o azul claro por amarelo
